...
function hotelLinks(dateStr: string) {
  ...
  return {
    jalan: `https://px.a8.net/svt/ejp?a8mat=4AZLSM+5N0U2A+14CS+64RJ5&a8ejpredirect=${encodeURIComponent(`https://www.jalan.net/yad/search/?kw=%E8%88%9E%E6%B5%9C&stayFrom=${checkIn}&stayTo=${checkOut}&adultNum=2&roomNum=1`)}`,
