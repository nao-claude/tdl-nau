      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        ...
        <div className="max-w-4xl mx-auto px-4 pb-2">
          <div className="flex gap-1 bg-gray-100 p-1 rounded-xl">
            ...
            <Link href="/en/attractions/tdl" className="flex-1 flex items-center justify-center py-2 rounded-lg text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-white/60 transition-colors">
              Land
            </Link>
