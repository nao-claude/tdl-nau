...
function hotelLinks(dateStr: string) {
  ...
  return {
    ...
    rakuten: `https://hb.afl.rakuten.co.jp/hgc/522dc3a1.a8f621bb.522dc3a2.b6743386/?pc=${encodeURIComponent(`https://travel.rakuten.co.jp/yado/search/?keyword=%E8%88%9E%E6%B5%9C&f_checkin=${y}${m}${d}&f_checkout=${co_y}${co_m}${co_d}&f_adult_num=2&f_room_num=1`)}`,
  };
}
