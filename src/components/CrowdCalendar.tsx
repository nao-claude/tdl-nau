...
function hotelLinks(dateStr: string) {
  ...
  return {
    jalan: `https://px.a8.net/svt/ejp?a8mat=4AZLSM+5N0U2A+14CS+64RJ5&a8ejpredirect=${encodeURIComponent(`https://www.jalan.net/yado/search/?kw=舞浜&stayFrom=${checkIn}&stayTo=${checkOut}&adultNum=2&roomNum=1`)}`,
