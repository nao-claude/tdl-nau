...
function hotelLinks(dateStr: string) {
  ...
  return {
    ...
    rakuten: `https://hb.afl.rakuten.co.jp/hgc/522dc3a1.a8f621bb.522dc3a2.b6743386/?pc=${encodeURIComponent(`https://search.travel.rakuten.co.jp/ds/station/condition/?f_teikei=ensen&f_eki=7930&f_nen1=${y}&f_tuki1=${Number(m)}&f_hi1=${Number(d)}&f_nen2=${co_y}&f_tuki2=${Number(co_m)}&f_hi2=${Number(co_d)}&f_heya_su=1&f_otona_su=2`)}`,
  };
}
